...
public abstract class ImaJ {
    ...
    */
    ...
    /**
     * Converte uma imagem em tons de cinza em uma imagem em preto e branco usando o limiar fornecido por parâmetro.
     * 
     * @param im Uma matriz de inteiros representando uma imagem em tons de cinza.
     * @param value Uma variável inteira representando o limiar a ser utilizado no condicional.
     * @return Uma matriz de booleans representando uma imagem em preto e branco.
     */
    public static boolean[][] im2bw(int[][] im,int value) {
        boolean[][] bw = new boolean[im.length][im[0].length];
